...
public class TvSegoeuiBoldItalic extends AppCompatTextView {
    private static Typeface mTypeface;

    public TvSegoeuiBoldItalic(final Context context) {
        this(context, null);
    }

    public TvSegoeuiBoldItalic(final Context context, final AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TvSegoeuiBoldItalic(final Context context, final AttributeSet attrs, final int defStyle) {

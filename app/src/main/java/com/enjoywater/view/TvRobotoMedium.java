...
public class TvRobotoMedium extends AppCompatTextView {
    ...
    public TvRobotoMedium(final Context context) {
        this(context, null);
    }

    public TvRobotoMedium(final Context context, final AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TvRobotoMedium(final Context context, final AttributeSet attrs, final int defStyle) {
        super(context, attrs, defStyle);
        if (mTypeface == null) {
            mTypeface = Typeface.createFromAsset(context.getAssets(), "robotomedium.ttf");
        }
